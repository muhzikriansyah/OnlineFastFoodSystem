...
namespace OnlineFastFoodSystem {
    ...
    public partial class foodDataSet1 : global::System.Data.DataSet {
        ...
        public partial class userDataTable : global::System.Data.TypedTableBase<userRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public userRow AdduserRow(string name, string mobile, string email, string street, string city) {
...
namespace OnlineFastFoodSystem.foodDataSet1TableAdapters {
    ...
    public partial class userTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[user] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_mobile = 1 AND [mobile] IS NULL) OR ([mobile] = @Original_mobile)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_street = 1 AND [street] IS NULL) OR ([street] = @Original_street)) AND ((@IsNull_city = 1 AND [city] IS NULL) OR ([city] = @Original_city)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[user] ([name], [mobile], [email], [street], [city]) VALUES (@n" +
                "ame, @mobile, @email, @street, @city);\r\nSELECT Id, name, mobile, email, street, " +
                "city FROM [user] WHERE (Id = SCOPE_IDENTITY())";
...
SELECT Id, name, mobile, email, street, city FROM [user] WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, mobile, email, street, city FROM dbo.[user]";
        ...
        public virtual int Fill(foodDataSet1.userDataTable dataTable) {
        ...
        public virtual foodDataSet1.userDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            foodDataSet1.userDataTable dataTable = new foodDataSet1.userDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(foodDataSet1.userDataTable dataTable) {
